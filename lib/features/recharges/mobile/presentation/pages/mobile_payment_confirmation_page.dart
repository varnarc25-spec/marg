...
import 'mobile_success_page.dart';

/// Payment confirmation before initiating recharge.
/// TODO: Integrate with payment gateway (UPI/card/netbanking).
class MobilePaymentConfirmationPage extends ConsumerWidget {
  const MobilePaymentConfirmationPage({super.key});
                  ...
                  child: ElevatedButton(
                    onPressed: isLoading
                        ...
                        : () async {
                            ...
                            final repo = ref.read(mobileRechargeRepositoryProvider);
                            ...
                            if (context.mounted) {
                              ...
                              if (ok) {
                                Navigator.of(context).pushAndRemoveUntil(
                                  MaterialPageRoute(builder: (_) => const MobileSuccessPage()),
                                  (route) => route.isFirst,
                                );
                              }
                            }
