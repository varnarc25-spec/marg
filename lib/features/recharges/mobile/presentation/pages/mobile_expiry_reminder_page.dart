    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          ...mockExpiry.map((e) => Card(
                margin: const EdgeInsets.only(bottom: 8),
                child: ListTile(
                  leading: const Icon(Icons.schedule_rounded, color: AppColors.accentOrange),
                  title: Text(e.number),
                  subtitle: Text(
...
class _ExpiryEntry {
  ...
  const _ExpiryEntry({required this.number, required this.operator, required this.expiryInDays});
}
