...
/// Shows the New expense UI as an adjustable bottom sheet (draggable to resize).
Future<void> showNewExpenseSheet(BuildContext context) {
  return showModalBottomSheet<void>(
    ...
    builder: (context) => DraggableScrollableSheet(
      ...
      minChildSize: 0.35,
      maxChildSize: 0.95,
      builder: (context, scrollController) => _NewExpenseSheetContent(
...
/// Content of the New expense bottom sheet.
class _NewExpenseSheetContent extends StatefulWidget {
  const _NewExpenseSheetContent({
  ...
  @override
  State<_NewExpenseSheetContent> createState() =>
      _NewExpenseSheetContentState();
}

class _NewExpenseSheetContentState extends State<_NewExpenseSheetContent> {
  ...
  static const List<({String name, IconData icon, Color color})> _categories = [
    (name: 'Bills', icon: Icons.receipt_long_rounded, color: Color(0xFFFF9800)),
    (name: 'Car', icon: Icons.directions_car_rounded, color: Color(0xFF2196F3)),
    (name: 'Cloths', icon: Icons.checkroom_rounded, color: Color(0xFFE91E63)),
    (name: 'Food', icon: Icons.restaurant_rounded, color: Color(0xFF4CAF50)),
    (
      name: 'Health',
    ...
    (name: 'Others', icon: Icons.more_horiz_rounded, color: Color(0xFF757575)),
  ];
...
IconData _iconForExpenseCategory(String name) {
  switch (name) {
    case 'Bills':
