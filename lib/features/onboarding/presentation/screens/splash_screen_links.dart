...
import '../../../auth/presentation/screens/otp_verification_screen.dart'
    show OtpVerificationScreen, AuthMethod;
...
List<SplashScreenLink> get splashScreenLinks => [
  ...
  SplashScreenLink(
    'Trade',
    'Trade Guidance',
    () => const TradeGuidanceScreen(),
  ),
  SplashScreenLink(
    'Trade',
    'Options Strategy Builder',
    () => const OptionsStrategyBuilderScreen(),
  ),
  SplashScreenLink(
    'Journal',
    'Trade Journal',
    () => const TradeJournalScreen(),
  ),
  ...
  SplashScreenLink(
    ...
    () => const StockTransactionsHistory(),
  ),
  SplashScreenLink(
    'Commodities',
    'Commodities Home',
    () => const CommoditiesHomePage(),
  ),
  SplashScreenLink(
    'Commodities',
    'Gold Details',
    () => const GoldDetailsScreen(),
  ),
  SplashScreenLink('Commodities', 'Gold Loan', () => const GoldLoanScreen()),
  SplashScreenLink(
    'Commodities',
    'Gold Redeem',
    () => const GoldRedeemScreen(),
  ),
  SplashScreenLink(
    'Commodities',
    'Gold Transactions',
    () => const GoldTransactionsScreen(),
  ),
  SplashScreenLink(
    'Commodities',
    'Gold Auto Invest',
    () => const GoldAutoInvestScreen(),
  ),
  SplashScreenLink(
    'Commodities',
    'Silver Details',
    () => const SilverDetailsScreen(),
  ),
  SplashScreenLink(
    'Commodities',
    'Silver Auto Invest',
    () => const SilverAutoInvestScreen(),
  ),
  SplashScreenLink(
    'Commodities',
    'Silver Loan',
    () => const SilverLoanScreen(),
  ),
  SplashScreenLink(
    'Commodities',
    'Silver Redeem',
    () => const SilverRedeemScreen(),
  ),
  SplashScreenLink(
    'Commodities',
    'Silver Transactions',
    () => const SilverTransactionsScreen(),
  ),
  ...
  SplashScreenLink(
    'Wallet',
    'Topup Confirmation',
    () => const TopupConfirmationScreen(amount: 100, fee: 2),
  ),
  SplashScreenLink(
    'Wallet',
    'Topup Select Method',
    () => const TopupSelectDepositMethodScreen(),
  ),
  ...
  SplashScreenLink(
    'Wallet',
    'Withdraw Select Destination',
    () => const WithdrawSelectDestinationScreen(),
  ),
  SplashScreenLink(
    'Wallet',
    'Transfer Balance',
  ...
  SplashScreenLink(
    'Wallet',
    'Transfer List Contact',
    () => const TransferBalanceListContactScreen(),
  ),
  SplashScreenLink(
    'Wallet',
    'Transfer Confirmation',
    () => TransferBalanceConfirmationScreen(
      amount: 567,
  ...
  SplashScreenLink(
    ...
    () => const NotificationVerifyEmailScreen(),
  ),
  ...
  SplashScreenLink(
    'History',
    'History Report V1',
    () => const HistoryReportV1Screen(),
  ),
  SplashScreenLink(
    'History',
    'History Report V2',
    () => const HistoryReportV2Screen(),
  ),
  SplashScreenLink(
    'History',
    'History Details Bar',
    () => const HistoryDetailsBarScreen(),
  ),
  SplashScreenLink(
    'History',
    'History Details Pie',
    () => const HistoryDetailsPieScreen(),
  ),
  SplashScreenLink(
    'History',
    'History Download Popup',
    () => const HistoryDownloadPopupScreen(),
  ),
  SplashScreenLink(
    'Portfolio',
    'My Portfolio',
