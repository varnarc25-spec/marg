...
import 'electricity_add_account_page.dart';

/// `GET /api/utilities/electricity/accounts`
class ElectricitySavedAccountsPage extends ConsumerWidget {
  const ElectricitySavedAccountsPage({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final async = ref.watch(electricitySavedAccountsProvider);
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () => ref.invalidate(electricitySavedAccountsProvider),
          ),
        ],
      ),
        ...
        onPressed: () async {
          final added = await Navigator.of(context).push<bool>(
            MaterialPageRoute<bool>(
              builder: (_) => const ElectricityAddAccountPage(),
            ),
          );
