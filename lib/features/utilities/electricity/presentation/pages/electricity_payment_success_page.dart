...
class ElectricityPaymentSuccessPage extends ConsumerWidget {
  const ElectricityPaymentSuccessPage({super.key});
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              if (bill != null) Text('₹${bill.amount} paid', style: const TextStyle(color: AppColors.textSecondary)),
