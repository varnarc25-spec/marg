...
/// `GET /api/utilities/electricity/history`
class ElectricityHistoryPage extends ConsumerWidget {
  const ElectricityHistoryPage({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final async = ref.watch(electricityHistoryProvider);
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () => ref.invalidate(electricityHistoryProvider),
          ),
        ],
      ),
      body: async.when(
