/// Saved account from `GET/POST/PUT/DELETE /api/utilities/broadband-landline/accounts`.
class BroadbandSavedAccount {
  BroadbandSavedAccount({
    required this.id,
  ...
  factory BroadbandSavedAccount.fromApiJson(Map<String, dynamic> json) {
    return BroadbandSavedAccount(
