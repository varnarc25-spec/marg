/// Saved account from `GET/POST/PUT/DELETE /api/utilities/water/accounts`.
class WaterSavedAccount {
  WaterSavedAccount({
    required this.id,
  ...
  factory WaterSavedAccount.fromApiJson(Map<String, dynamic> json) {
    return WaterSavedAccount(
