...
/// Purple accent for redeem gold (per design)
const Color _redeemPurple = Color(0xFF6C63FF);

/// Gold color for gold icon
const Color _goldColor = Color(0xFFD4AF37);

/// Gold Redeem screen – Gold balance header, amount input, quick amounts, keypad, redeem button
class GoldRedeemScreen extends StatefulWidget {
  const GoldRedeemScreen({super.key});

  @override
  State<GoldRedeemScreen> createState() => _GoldRedeemScreenState();
}

class _GoldRedeemScreenState extends State<GoldRedeemScreen> {
  static const double _goldBalance = 100; // gr
  ...
  Widget _buildRedeemButton(BuildContext context) {
    final canRedeem = _amount > 0 && _amount <= _goldBalance;
    return Padding(
