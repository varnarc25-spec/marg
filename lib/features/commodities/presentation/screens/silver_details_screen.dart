...
import 'silver_auto_invest_screen.dart';
import 'silver_redeem_screen.dart';

/// Purple accent for silver details (per design)
const Color _silverPurple = Color(0xFF6C63FF);

/// Silver color for silver icon
const Color _silverColor = Color(0xFFC0C0C0);

/// Silver Details – Detail view for silver: price, chart, time range, actions, buy
class SilverDetailsScreen extends StatefulWidget {
  const SilverDetailsScreen({super.key});

  @override
  State<SilverDetailsScreen> createState() => _SilverDetailsScreenState();
}

class _SilverDetailsScreenState extends State<SilverDetailsScreen> {
  static const List<String> _timeRanges = ['24H', '1W', '1M', '1Y', 'ALL'];
  int _selectedTimeRangeIndex = 4; // ALL selected

  // Sample chart: Oct 10–13, prices
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Silver Details'),
        centerTitle: true,
        backgroundColor: Theme.of(context).colorScheme.surface,
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 28),
                    _buildAboutSilverSection(context),
                    const SizedBox(height: 28),
  ...
  Widget _buildSilverOverview(BuildContext context) {
    return Row(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Expanded(
        ...
        Container(
          ...
          decoration: BoxDecoration(
            ...
            boxShadow: [
              BoxShadow(
                color: _silverColor.withValues(alpha: 0.4),
                blurRadius: 8,
                      ...
                      Material(
                        ...
                        child: InkWell(
                              ...
                              if (i == 2) {
                                Navigator.of(context).push(
                                  MaterialPageRoute<void>(
                                    builder: (_) => const SilverAutoInvestScreen(),
                                  ),
                                );
                              } else if (i == 3) {
                                Navigator.of(context).push(
                                  MaterialPageRoute<void>(
                                    builder: (_) => const SilverRedeemScreen(),
                                  ),
                                );
                              }
                            },
                          ...
                          child: Padding(
                            ...
                            child: Icon(actions[i].icon, size: 24, color: _silverPurple),
                          ),
                        ),
                      ),
  ...
  Widget _buildAboutSilverSection(BuildContext context) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text(
        ...
        Text(
          'Silver investment generally provides good protection against dollar deprecation, and inflation and thus acts as a store of value.',
          style: Theme.of(context).textTheme.bodyMedium?.copyWith(
                color: Theme.of(context).colorScheme.onSurfaceVariant,
                height: 1.5,
              ),
