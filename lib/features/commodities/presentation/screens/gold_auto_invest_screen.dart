...
/// Gold color for gram icon
const Color _goldColor = Color(0xFFD4AF37);

/// Gold Auto Invest screen – amount input, estimated grams, keypad, review button (opened from Loan icon)
class GoldAutoInvestScreen extends StatefulWidget {
  const GoldAutoInvestScreen({super.key});

  @override
  State<GoldAutoInvestScreen> createState() => _GoldAutoInvestScreenState();
}

class _GoldAutoInvestScreenState extends State<GoldAutoInvestScreen> {
  static const double _walletBalance = 13029.46;
  // Approx USD per gram for gold (~97.7 so 100 USD ≈ 1.0234 g)
  static const double _usdPerGram = 97.7;
