...
/// Purple accent for silver loan (per design)
const Color _loanPurple = Color(0xFF6C63FF);

/// Silver Loan screen – Create Loan: silver quantity slider, tenure chips, loan simulation, review
class SilverLoanScreen extends StatefulWidget {
  const SilverLoanScreen({super.key});

  @override
  State<SilverLoanScreen> createState() => _SilverLoanScreenState();
}

class _SilverLoanScreenState extends State<SilverLoanScreen> {
  static const double _pricePerGram = 0.97;
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _buildSilverQuantitySection(context),
  ...
  Widget _buildSilverQuantitySection(BuildContext context) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Row(
